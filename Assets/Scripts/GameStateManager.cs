...
public class GameStateManager : MonoBehaviour {
	...
	public enum GameState {
        ANIMAL_SPAWNING, // The animal is spawning
        ANIMAL_ENTERING, // The animal is entering the game
        ANIMAL_PLAYING_READY_ANIMATION, // The sacrifical animal is playing some kind of "entry animation"
        SETTING_UP_SACRIFICE, // The player is setting up the sacrifice
        SACRIFICING, // The game is sacrificing the animal (determining the results)
        ANIMAL_PLAYING_DEATH_ANIMATION, // The animal is playing a death animation (player wins)
